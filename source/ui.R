...
ui <- navbarPage(
  ...
  tabPanel(
    ...
    img(src = "https://imageio.forbes.com/specials-images/imageserve/60c35192ba409e6fc1b4012e/Self-Driving-car/0x0.jpg", height=200, width=350),
    hr(),
  ...
  tabPanel(
    ...
    img(src = "https://i.ibb.co/FHYmF17/adas-map.png", height=200, width=350),
    img(src = "https://i.ibb.co/93X8Ht8/ads-map.png", height=200, width=350),
    hr(),
    ...
    img(src = "https://i.ibb.co/7VsbTDZ/adas-types-of-crahses.png", height=180, width=250),
    img(src = "https://i.ibb.co/8MJctSt/ads-types-of-crashes.png", height=200, width=250),
    hr(),
    ...
    img(src = "https://i.ibb.co/XkY8ryV/adas-roadway.png", height=250, width=500), 
    img(src = "https://i.ibb.co/hcMvnKn/ads-roadway.png", height=250, width=500), 
    hr(),
    h4("Conclusion"),
